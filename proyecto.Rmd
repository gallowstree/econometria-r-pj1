...
all_data$median_house_value<-all_data$median_house_value / median_house_value_scale
all_data
```
...
imputeTotalBedrooms<-function(df) {
  df$total_bedrooms<-ifelse(is.na(df$total_bedrooms), 
                                predict(total_bedroom_imputer, data.frame(df$households)), 
                                df$total_bedrooms)
}

#data$train$total_bedrooms<-ifelse(is.na(data$train$total_bedrooms), 
#                                predict(total_bedroom_imputer, data.frame(data$train$households)), 
#                                data$train$total_bedrooms)

imputeTotalBedrooms(data$train)
imputeTotalBedrooms(data$test)
imputeTotalBedrooms(data$validate)
